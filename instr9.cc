...
namespace vm68k
{
  ...
  install_instructions_9(processor &p, unsigned long d)
  {
    static const instruction_map inst[]
	 ...
	 {0x90d8, 0xe07, &_suba<word_size, word_postinc_indirect>},
	 {0x90e0, 0xe07, &_suba<word_size, word_predec_indirect>},
	 {0x90e8, 0xe07, &_suba<word_size, word_disp_indirect>},
	 {0x90f0, 0xe07, &_suba<word_size, word_index_indirect>},
	 {0x90f8, 0xe00, &_suba<word_size, word_abs_short>},
	 {0x90f9, 0xe00, &_suba<word_size, word_abs_long>},
	 {0x90fa, 0xe00, &_suba<word_size, word_disp_pc_indirect>},
	 {0x90fb, 0xe00, &_suba<word_size, word_index_pc_indirect>},
	 {0x90fc, 0xe00, &_suba<word_size, word_immediate>},
	 {0x9110, 0xe07, &_sub_m<byte_size, byte_indirect>},
	 {0x9118, 0xe07, &_sub_m<byte_size, byte_postinc_indirect>},
	 {0x9120, 0xe07, &_sub_m<byte_size, byte_predec_indirect>},
	 {0x9128, 0xe07, &_sub_m<byte_size, byte_disp_indirect>},
	 {0x9130, 0xe07, &_sub_m<byte_size, byte_index_indirect>},
	 {0x9138, 0xe00, &_sub_m<byte_size, byte_abs_short>},
	 {0x9139, 0xe00, &_sub_m<byte_size, byte_abs_long>},
	 {0x9150, 0xe07, &_sub_m<word_size, word_indirect>},
	 {0x9158, 0xe07, &_sub_m<word_size, word_postinc_indirect>},
	 {0x9160, 0xe07, &_sub_m<word_size, word_predec_indirect>},
	 {0x9168, 0xe07, &_sub_m<word_size, word_disp_indirect>},
	 {0x9170, 0xe07, &_sub_m<word_size, word_index_indirect>},
	 {0x9178, 0xe00, &_sub_m<word_size, word_abs_short>},
	 {0x9179, 0xe00, &_sub_m<word_size, word_abs_long>},
	 {0x9190, 0xe07, &_sub_m<long_word_size, long_word_indirect>},
	 {0x9198, 0xe07, &_sub_m<long_word_size, long_word_postinc_indirect>},
	 {0x91a0, 0xe07, &_sub_m<long_word_size, long_word_predec_indirect>},
	 {0x91a8, 0xe07, &_sub_m<long_word_size, long_word_disp_indirect>},
	 {0x91b0, 0xe07, &_sub_m<long_word_size, long_word_index_indirect>},
	 {0x91b8, 0xe00, &_sub_m<long_word_size, long_word_abs_short>},
	 {0x91b9, 0xe00, &_sub_m<long_word_size, long_word_abs_long>},
	 {0x91c0, 0xe07, &_suba<long_word_size, long_word_d_register>},
	 {0x91c8, 0xe07, &_suba<long_word_size, long_word_a_register>},
	 {0x91d0, 0xe07, &_suba<long_word_size, long_word_indirect>},
	 {0x91d8, 0xe07, &_suba<long_word_size, long_word_postinc_indirect>},
	 {0x91e0, 0xe07, &_suba<long_word_size, long_word_predec_indirect>},
	 {0x91e8, 0xe07, &_suba<long_word_size, long_word_disp_indirect>},
	 {0x91f0, 0xe07, &_suba<long_word_size, long_word_index_indirect>},
	 {0x91f8, 0xe00, &_suba<long_word_size, long_word_abs_short>},
	 {0x91f9, 0xe00, &_suba<long_word_size, long_word_abs_long>},
	 {0x91fa, 0xe00, &_suba<long_word_size, long_word_disp_pc_indirect>},
	 {0x91fb, 0xe00, &_suba<long_word_size, long_word_index_pc_indirect>},
	 {0x91fc, 0xe00, &_suba<long_word_size, long_word_immediate>}};
