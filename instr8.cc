...
namespace vm68k
{
  namespace instr
  {
    ...
    /* Handles an OR instruction (register destination).  */
  ...
  install_instructions_8(processor &p, unsigned long d)
  {
    static const instruction_map inst[]
      = {{0x8000, 0xe07, &_or_r<byte_size, byte_d_register>},
	 {0x8010, 0xe07, &_or_r<byte_size, byte_indirect>},
	 {0x8018, 0xe07, &_or_r<byte_size, byte_postinc_indirect>},
	 {0x8020, 0xe07, &_or_r<byte_size, byte_predec_indirect>},
	 {0x8028, 0xe07, &_or_r<byte_size, byte_disp_indirect>},
	 {0x8030, 0xe07, &_or_r<byte_size, byte_index_indirect>},
	 {0x8038, 0xe00, &_or_r<byte_size, byte_abs_short>},
	 {0x8039, 0xe00, &_or_r<byte_size, byte_abs_long>},
	 {0x803a, 0xe00, &_or_r<byte_size, byte_disp_pc_indirect>},
	 {0x803b, 0xe00, &_or_r<byte_size, byte_index_pc_indirect>},
	 {0x803c, 0xe00, &_or_r<byte_size, byte_immediate>},
	 {0x8040, 0xe07, &_or_r<word_size, word_d_register>},
	 {0x8050, 0xe07, &_or_r<word_size, word_indirect>},
	 {0x8058, 0xe07, &_or_r<word_size, word_postinc_indirect>},
	 {0x8060, 0xe07, &_or_r<word_size, word_predec_indirect>},
	 {0x8068, 0xe07, &_or_r<word_size, word_disp_indirect>},
	 {0x8070, 0xe07, &_or_r<word_size, word_index_indirect>},
	 {0x8078, 0xe00, &_or_r<word_size, word_abs_short>},
	 {0x8079, 0xe00, &_or_r<word_size, word_abs_long>},
	 {0x807a, 0xe00, &_or_r<word_size, word_disp_pc_indirect>},
	 {0x807b, 0xe00, &_or_r<word_size, word_index_pc_indirect>},
	 {0x807c, 0xe00, &_or_r<word_size, word_immediate>},
	 {0x8080, 0xe07, &_or_r<long_word_size, long_word_d_register>},
	 {0x8090, 0xe07, &_or_r<long_word_size, long_word_indirect>},
	 {0x8098, 0xe07, &_or_r<long_word_size, long_word_postinc_indirect>},
	 {0x80a0, 0xe07, &_or_r<long_word_size, long_word_predec_indirect>},
	 {0x80a8, 0xe07, &_or_r<long_word_size, long_word_disp_indirect>},
	 {0x80b0, 0xe07, &_or_r<long_word_size, long_word_index_indirect>},
	 {0x80b8, 0xe00, &_or_r<long_word_size, long_word_abs_short>},
	 {0x80b9, 0xe00, &_or_r<long_word_size, long_word_abs_long>},
	 {0x80ba, 0xe00, &_or_r<long_word_size, long_word_disp_pc_indirect>},
	 {0x80bb, 0xe00, &_or_r<long_word_size, long_word_index_pc_indirect>},
	 {0x80bc, 0xe00, &_or_r<long_word_size, long_word_immediate>},
